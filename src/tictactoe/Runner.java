...
/**
 * See http://sentientmachine.blogspot.com/2009/07/l07-java-code-to-learn-perfect-game-of.html 
 * @author Ron.Coleman
 */
...
public class Runner {
	...
	//The choices are a Loss or a Draw.  Position 2 is Draw, Position 0 is loss.
        ...
        player1StateArray = new ArrayList<>();
        //This is a list of the cup contents by state.
        player1CupContents = new ArrayList<>();

        //This is a list of all the states.  player2StateArray and player2CupContents are the same length.
        player2StateArray = new ArrayList<>();
        //This is a list of the cup contents by state.
        player2CupContents = new ArrayList<>();

        player1CupsDrawnFromArray = new ArrayList<>();
        player1ColorDrawnFromCupArray = new ArrayList<>();

        player2CupsDrawnFromArray = new ArrayList<>();
        player2ColorDrawnFromCupArray = new ArrayList<>();
    ...
    public static char testStateSeeWhoWins(String state) {
        ...
        ArrayList<String> winningPositions = new ArrayList<>();
        ...
        for (String winningPosition : winningPositions) {
            if (state.charAt(Integer.parseInt(winningPosition.charAt(0) + "")) != ' ' && state.charAt(Integer.parseInt(winningPosition.charAt(0) + "")) == state.charAt(Integer.parseInt(winningPosition.charAt(1) + "")) && state.charAt(Integer.parseInt(winningPosition.charAt(1) + "")) == state.charAt(Integer.parseInt(winningPosition.charAt(2) + ""))) {
                return state.charAt(Integer.parseInt(winningPosition.charAt(0) + ""));
            }
        }
	...
	//player 1 is always 'X'.  Given the passed in state,
        ...
        int randomMove = player1_get_random_move_from_cup_contents(stateIndex);
